    ...
    <c:otherwise>
		...
		<div id="content-wrapper" class="d-flex flex-column"
			...
			<div id="content">
				...
				<a href="/FoodFamily/menu/addDeal" class="btn btn-success btn-lg btn-icon-split" style="float: right; margin-top: 2%;margin-right:3%">
				...
				<div class="container-fluid">
					...
					<h1 style="margin-top: 5%; color: lightgrey">Add Food to Menu</h1>
							...
							<div class="p-5">
								<form class="user" method="post" action="add">
									<div class="form-group row">
										<div class="col-sm-6 mb-3 mb-sm-0">
											<input type="name" class="form-control form-control-user"
												...
												style="border-radius: 25px; float: left;" required>
										</div>
										<div class="col-sm-6">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											<input type="contact" class="form-control form-control-user"
												name="price" placeholder="Retail Price"
												style="border-radius: 25px; float: left;" required>
										</div>
										<div class="col-sm-6">
											<input type="contact" class="form-control form-control-user"
												name="cost" placeholder="Cost Price"
												style="border-radius: 25px; float: left;" required>
										</div>
									</div>
