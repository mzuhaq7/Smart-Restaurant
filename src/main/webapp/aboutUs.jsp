				...
				<div class="container-fluid">
					<div style="text-align: center;">
						<div class="text-center " style="margin-top: 4%;">
							<img
								src="${pageContext.request.contextPath}/resources/pics/goal.svg"
								style="color: #0275d8; width: 10%; height: 10%;">
						</div>
						<!-- Basic Card Example -->
						<div class="card shadow mb-4"
							style="width: 50%; margin-left: 25%; margin-top: 3%;">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Our Success
									Story</h6>
							</div>
							<div class="card-body">There's a saying in Texas: "The
								smallest dog barks the loudest." A confident man doesn't feel a
								need to prove that he's confident. A rich woman doesn't feel a
								need to convince anybody that she's rich. Either you are or you
								are not. And if you're dreaming of something all the time, then
								you're reinforcing the same unconscious reality over and over:
								that you are not that.</div>
						</div>
						<a href="#" class="btn btn-success btn-icon-split"> <span
							class="icon text-white-50"> <i class="fas fa-thumbs-up"></i>
						</span> <span class="text">Follow Us On&nbsp;&nbsp;</span>
						</a><br>
						<br> <a href="#" class="btn btn-primary btn-circle"> <i
