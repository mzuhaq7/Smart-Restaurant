...
<c:choose>
	...
	<div id="content-wrapper" class="d-flex flex-column"
			...
			<div id="content">
				...
				<img
					src="${pageContext.request.contextPath}/resources/pics/editStaff.svg"
					alt="Image Not Found"
					style="width: 400px; height: 400px; float: right; margin-top: 8%; margin-right: 5%;">
				<div class="container-fluid">

					<h1 style="margin-top: 2%; color: lightgrey">Edit Staff
						Information</h1>
					...
					<div class="dropdown mb-4">
						<div class="col-lg-6">
							<div class="p-5">
								<form class="user" action="edit" method="post" required>
									...
									<div class="form-group row">
										<input type="username" class="form-control form-control-user"
											name="salary" value="${staff.getSalary()}"
											style="border-radius: 25px;">
									</div>
									<div class="form-group row">
										<input type="email" class="form-control form-control-user"
											name="email" value="${staff.getEmail()}"
											style="border-radius: 25px;">
									</div>
									<div class="form-group row">
										<input type="contact" class="form-control form-control-user"
											name="contact" value="${staff.getContactNo()}"
											style="border-radius: 25px;">
									</div>
									<button type="submit" class="btn btn-success btn-user btn-block row"
										style="border-radius: 25px;">Edit</button>
								</form>
							</div>
						</div>
					</div>
