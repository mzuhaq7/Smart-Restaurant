...
<c:choose>
    ...
    <div id="content-wrapper" class="d-flex flex-column"
            ...
            <div id="content">
                ...
                <input type="image" src="${pageContext.request.contextPath}/resources/pics/logout.svg" alt="Submit" style="margin-right: 3%;width: 5%;height: 5%; float: right;margin-top: 2%;">
                    ...
                    <div>
                        <div class="p-5 ">
                            ...
                            <div class="text-center ">
                                <div class="font-weight-bold text-uppercase mb-4 " style="font-size: 40px;color:lightgray">List of Complaints
                                    <img src="${pageContext.request.contextPath}/resources/pics/complaint.svg" style="margin-left: 5%;color:#0275d8; width: 100px;height: 100px; ">
                                ...
                                <tbody>
		                            <c:forEach items="${queries}" var="query" varStatus="loop">
									    <tr style="color:lightgray; ">
									        ...
									        <td><c:out value="${query.customer_id}"/></td>
									        <td><form id="${loop.count}" action="resolvequery" style="text-decoration: underline;color: lightgrey;">
									        <a href="javascript: submitform('${loop.count}')" style="text-decoration: underline;color: lightgrey;">Resolve</a>
									        
									        <input hidden value="${query.message}" name="msg">
									        <input hidden value="${query.customer_id}" name="cid">
									        </form></td>
            ...
            <footer class="main-footer ">
                <!-- To the right -->
                <div align="center">
                    <strong>Copyrights <a href="# ">Company</a> <sup>©</sup> </strong> Food Family &nbsp;
                </div>
                <!-- Default to the left -->
            </footer>
            <!-- End of Footer -->
